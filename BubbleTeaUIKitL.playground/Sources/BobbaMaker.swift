...
public struct Bobba : BobbaDecorator {
    ...
    func getIngredientByName(name: String) -> Ingredient? {
        ...
        let n: [Ingredient] = ingredients.filter{ $0.name == name }
    ...
    func sortMostCaloricIngredient() -> Ingredient {
        ...
        let ingMostCaloric = ingredients.sorted(by: { $0.calories > $1.calories })
        
        return ingMostCaloric[0]
    }
